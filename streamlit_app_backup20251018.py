...
# available_purposes = sorted(df['title'].dropna().unique())
# friendly_options = [
...
# st.markdown()
st.text("Loans Shown:".ljust(25) + str(len(filtered)))
st.text("Date Range:".ljust(25) + f"{year_range[0]} – {year_range[1]}")
st.text("Filtered Purposes:".ljust(25) + ', '.join(purpose_filter))
...
with col2:
    ...
    fig = st.bar_chart(filtered,x='grade', y='loan_amount', color='grade', use_container_width=True)
